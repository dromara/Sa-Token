...
/**
 * Http 请求处理器， RestTemplate 版实现
 *
 * @author click33
 * @since 1.45.0
 */
public class SaHttpTemplateForRestTemplate implements SaHttpTemplate {
	...
	public String postByFormData(String url, Map<String, Object> params) {
		...
		String res = restTemplate.postForObject(url, formData, String.class);
		SaManager.log.debug("返回结果：{}", res);
		return res;
	}
