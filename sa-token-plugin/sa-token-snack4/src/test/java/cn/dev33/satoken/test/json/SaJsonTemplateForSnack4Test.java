...
import cn.dev33.satoken.test.json.SaJsonTemplateTestCommon;
...
public class SaJsonTemplateForSnack4Test extends SaJsonTemplateTestCommon {
	...
	void classNotFoundKeepsOriginalMessage() {
		assertClassNotFoundMessage(new SaJsonTemplateForSnack4(),
				"{\"@type\":\"cn.dev33.satoken.test.model.NonExistentJsonType\",\"mode\":3}",
				"Blocked type, class: cn.dev33.satoken.test.model.NonExistentJsonType");
	}
	...
	void allowsExactWhitelistTypeName() {
		...
		SaJsonTemplateForSnack4 template = new SaJsonTemplateForSnack4();
		Object obj = template.jsonToObject("{\"@type\":\"cn.dev33.satoken.test.json.SaJsonTemplateForSnack4Test$PlainPoint\",\"x\":10,\"y\":20}");
		Assertions.assertTrue(obj instanceof PlainPoint);
		Assertions.assertEquals("cn.dev33.satoken.test.json.SaJsonTemplateForSnack4Test$PlainPoint", obj.getClass().getName());
	}
