 ...
 */
package cn.dev33.satoken.context.dubbo.support;
...
/**
 * Dubbo 2.x 插件单测现场：假 Invoker、假 Invocation、清 RpcContext。
 */
public final class DubboTestSupport {

	private DubboTestSupport() {
	}
