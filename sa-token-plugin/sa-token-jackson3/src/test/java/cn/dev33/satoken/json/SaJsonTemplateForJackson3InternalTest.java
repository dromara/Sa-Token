...
/**
 * {@link SaJsonTemplateForJackson3} 包级静态方法与异常包装内部测试
 *
 * @author click33
 * @since 1.46.0
 */
public class SaJsonTemplateForJackson3InternalTest {
	...
	void wrapsSerializeException() {
		Assertions.assertThrows(SaJsonConvertException.class,
				() -> new SaJsonTemplateForJackson3().objectToJson(new BadBean()));
	}
	...
	void isWhitelistDenied_nullMessage() {
		...
		Assertions.assertFalse(SaJsonTemplateForJackson3.isWhitelistDenied(e));
	}
