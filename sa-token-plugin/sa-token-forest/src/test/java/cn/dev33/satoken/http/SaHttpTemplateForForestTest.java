...
/**
 * {@link SaHttpTemplateForForest} 测试：基于本地 Http 服务器做真实请求验证
 *
 * @author click33
 * @since 1.46.0
 */
public class SaHttpTemplateForForestTest extends SaHttpTemplateTestCommon {

    @Override
    protected SaHttpTemplate createTemplate() {
        return new SaHttpTemplateForForest();
    }
    ...
    /** 应测尽测：测试 SaHttpTemplateForForest 无参构造 */
    @Test
    public void constructor_instantiable() {
        Assertions.assertNotNull(new SaHttpTemplateForForest());
    }
