...
- 插件：
	...
	- 新增：新增 `sa-token-alone-redisson` 独立连接插件及 Spring Boot 3/4 示例。  **[重要]**  fix: [#710](https://github.com/dromara/Sa-Token/issues/710)、[#ICE2V0](https://gitee.com/dromara/sa-token/issues/ICE2V0)
...
- starter：
	...
	- 修复：Boot3+ WebFlux/Gateway `setStatus` NoSuchMethodError。  fix: [#IIAW1A](https://gitee.com/dromara/sa-token/issues/IIAW1A)、[#916](https://github.com/dromara/Sa-Token/issues/916)、[#IHRIBY](https://gitee.com/dromara/sa-token/issues/IHRIBY)
