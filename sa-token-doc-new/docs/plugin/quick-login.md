...
<img class="s-w" src="/big-file/doc/plugin/sa-quick-login.png" alt="Quick-Login 插件登录页" />

使用默认账号：`sa / 123456`进行登录，会看到资源页面

<img class="s-w" src="/big-file/doc/plugin/sa-quick-login-index.png" alt="Quick-Login 插件首页" />
...
<img class="s-w" src="/big-file/doc/plugin/sa-quick-start.png" alt="Quick-Login 插件快速开始界面" />
...
<img class="s-w" src="/big-file/doc/plugin/sa-quick-case.png" alt="Quick-Login 插件完整示例运行效果" />
