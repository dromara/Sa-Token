...
<img class="s-w" src="/big-file/doc/plugin/sa-check-el-code-tips.png" alt="IDEA 中 SpEL 表达式注解鉴权代码提示" />
...
<img class="s-w" src="/big-file/doc/plugin/sa-check-el-setup-plugin.png" alt="IDEA 安装 SpEL Assistant 插件" />
