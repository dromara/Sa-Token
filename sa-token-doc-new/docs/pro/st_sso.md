---
description: "Sa-Pro 单点登录商业版：根据 SSO 模块文档与官方 Demo 延伸的完整认证中心，覆盖同域跨域、共享或跨 Redis、前后端一体或分离、vue2/vue3、Java 与非 Java。全套源码无加密 jar、可二开，不限域名与项目数。下载源码即可启动。本页入口跟踪参数为 way=st_sso。"
---
