...
``` xml
<!-- Sa-Token 整合 Solon, 在线文档：https://sa-token.com -->
<dependency>
	<groupId>cn.dev33</groupId>
...
``` xml
<!-- Sa-Token 整合 JFinal, 在线文档：https://sa-token.com -->
<dependency>
	<groupId>cn.dev33</groupId>
...
``` xml
<!-- Sa-Token 整合 Jboot, 在线文档：https://sa-token.com -->
<dependency>
	<groupId>cn.dev33</groupId>
...
``` xml
<!-- Sa-Token 整合 LoveQQ-Framework, 在线文档：https://sa-token.com -->
<dependency>
	<groupId>cn.dev33</groupId>
...
``` xml
<!-- Sa-Token 整合 Quarkus, 在线文档：https://sa-token.com -->
<dependency>
...
``` xml
<!-- Sa-Token 权限认证（ServletAPI规范）, 在线文档：https://sa-token.com -->
<dependency>
	<groupId>cn.dev33</groupId>
...
``` xml
<!-- Sa-Token 权限认证（core核心包）, 在线文档：https://sa-token.com -->
<dependency>
	<groupId>cn.dev33</groupId>
...
Maven依赖一直无法加载成功？[参考解决方案](https://sa-token.com/start/maven-pull.html)
