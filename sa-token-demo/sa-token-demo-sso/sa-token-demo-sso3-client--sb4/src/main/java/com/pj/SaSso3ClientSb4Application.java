...
public class SaSso3ClientSb4Application {

	public static void main(String[] args) {
		SpringApplication.run(SaSso3ClientSb4Application.class, args);

		System.out.println();
		System.out.println("---------------------- Sa-Token SSO 模式三 Client 端启动成功 (Spring Boot 4 + RestClient) ----------------------");
