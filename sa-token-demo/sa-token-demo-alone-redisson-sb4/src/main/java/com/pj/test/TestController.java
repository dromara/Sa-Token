...
/**
 * 测试专用Controller，演示 alone-redisson 在 Spring Boot 4 下权限缓存与业务缓存分离
 *
 * @author click33
 */
@RestController
...
public class TestController {
	...
	// 测试 Sa-Token 缓存，浏览器访问： http://localhost:8086/test/login
	...
	// 测试业务缓存，浏览器访问： http://localhost:8086/test/test
	@RequestMapping("test")
