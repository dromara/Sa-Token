 ...
 */
package cn.dev33.satoken.integration.boot4.diff;
...
/**
 * Boot 4 Jakarta Servlet 上下文差异测试：验证 request / response / storage / context util 在真实请求链路中可用。
 */
