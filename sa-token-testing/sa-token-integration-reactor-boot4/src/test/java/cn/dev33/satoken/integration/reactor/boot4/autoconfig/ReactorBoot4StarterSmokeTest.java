 ...
 */
package cn.dev33.satoken.integration.reactor.boot4.autoconfig;
...
/**
 * Boot 4 Reactor Starter 冒烟测试：只验证容器能启动且核心 Bean 存在，不重复 reactor-boot2 的全量集成。
 */
@SpringBootTest(classes = IntegrationReactorBoot4Application.class)
public class ReactorBoot4StarterSmokeTest {

    @Autowired
    private ApplicationContext applicationContext;

    /** Boot 4 WebFlux 上下文应该能正常启动 */
    @Test
