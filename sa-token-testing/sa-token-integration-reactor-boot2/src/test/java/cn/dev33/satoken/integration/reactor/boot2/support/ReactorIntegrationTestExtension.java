 ...
 */
public class ReactorIntegrationTestExtension implements BeforeEachCallback, AfterEachCallback {

    /** 从 Spring 容器同步 StpInterface 到 SaManager，保证鉴权读到测试配置 */
    @Override
    ...
    /** 每个用例结束后登出、清 Reactor 上下文、重置 StpLogic 并清空内存 DAO 缓存 */
    @Override
