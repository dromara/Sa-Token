...
public class SaOAuth2BeanInjectTest {
	...
	public void injectMethods_shouldWriteIntoManagers() {
		...
		Assertions.assertSame(scopeHandler, SaOAuth2Strategy.instance.scopeHandlerMap.get("loveqq-test-scope"));

		SaOAuth2GrantTypeHandlerInterface grantHandler = new SaOAuth2GrantTypeHandlerInterface() {
			@Override
			public String getHandlerGrantType() {
				return "loveqq_test_grant";
			}
		...
		Assertions.assertSame(grantHandler, SaOAuth2Strategy.instance.grantTypeHandlerMap.get("loveqq_test_grant"));
	}
