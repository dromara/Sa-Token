...
/**
 * Boot 3 Starter 应通过 AutoConfiguration.imports 声明上下文注册器
 */
public class AutoConfigurationImportsTest {

    private static final String IMPORTS_PATH =
            "META-INF/spring/org.springframework.boot.autoconfigure.AutoConfiguration.imports";
    private static final String REGISTER_CLASS = "cn.dev33.satoken.spring.SaTokenContextRegister";

    /** classpath 上应该能找到 AutoConfiguration.imports，并且声明了 SaTokenContextRegister */
    @Test
